...
export function voletBatir(monde, rendu) {
  ...
  const gare = `<h3>Fonder</h3>
    ...
    <div class="note">Une gare s'installe <b>hors de tout territoire</b> et fonde une localité.
      ...
      où l'on bâtit où l'on veut — mais elle ne vous en donne aucune : le sol s'achète case par
      case, au moment où l'on bâtit, comme partout ailleurs.<br><br>
      Elle n'apporte rien d'autre que du pain, de quoi tenir le temps que les premières fermes
      sortent de terre. Ni maisons, ni ateliers : tout se bâtit, et les matériaux viennent de la
      ville la plus proche — un dixième de la commande par mois tant qu'aucune voie ne relie le
      hameau.<br><br>
      Elle n'apporte <b>pas d'habitants</b> non plus. La population vient d'elle-même dès qu'elle
      trouve du travail et de quoi manger.<br><br>
