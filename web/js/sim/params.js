...
export const P = {
  ...
  // La recette mensuelle d'un ouvrier sur une case 1, au prix de référence.
  // L'écart au salaire est ce qui paie l'entretien — et c'est lui qui fixe le
  // capital d'une exploitation, puisque « case 1 = rendement nul » veut dire
  // « marge brute = entretien ».
  recetteOuvrierQ1: 24,
...
export const CAPITAL_CASE = 120 * P.echelleIndustrielle * (P.recetteOuvrierQ1 - P.salaireCase);
...
function echelonPour(rendementVise, indicePrix) {
  ...
  const num = rendementVise * C + P.entretienAnnuel * C + 12 * k * P.salaireCase;
